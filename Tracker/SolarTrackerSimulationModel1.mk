###########################################################################
## Makefile generated for component 'SolarTrackerSimulationModel1'. 
## 
## Makefile     : SolarTrackerSimulationModel1.mk
## Generated on : Sat Apr 24 16:29:45 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/SolarTrackerSimulationModel1.elf
...
PRODUCT_NAME              = SolarTrackerSimulationModel1
MAKEFILE                  = SolarTrackerSimulationModel1.mk
MATLAB_ROOT               = H:/matlab
MATLAB_BIN                = H:/matlab/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/Goblin/Desktop/лапки-21-2/Курсач
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH        = C:/Users/Goblin/DOCUME~1/MATLAB/R2021a/ARDUIN~1/ARDUIN~1/FASTER~1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SolarTrackerSimulationModel1.elf
...
DEFINES_STANDARD = -DMODEL=SolarTrackerSimulationModel1 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = SolarTrackerSimulationModel1.o SolarTrackerSimulationModel1_data.o updown.o ext_work.o rtiostream_utils.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_interface.o ext_svr_daemon.o rtiostream_serial_daemon.o daemon_checksum.o
...
%.o : $(START_DIR)/SolarTrackerSimulationModel1_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/SolarTrackerSimulationModel1_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/SolarTrackerSimulationModel1_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
SolarTrackerSimulationModel1.o : $(START_DIR)/SolarTrackerSimulationModel1_ert_rtw/SolarTrackerSimulationModel1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


SolarTrackerSimulationModel1_data.o : $(START_DIR)/SolarTrackerSimulationModel1_ert_rtw/SolarTrackerSimulationModel1_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/SolarTrackerSimulationModel1_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
